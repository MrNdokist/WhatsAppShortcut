...
public class VideoRecentAdapter extends BaseAdapter {
    private Context a;
    private ArrayList<File> filesList;


    public VideoRecentAdapter(ArrayList<File> filesList, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (currentFile.getAbsolutePath().endsWith(".mp4")||currentFile.getAbsolutePath().endsWith(".gif") ||currentFile.getAbsolutePath().endsWith(".3gp")) {
